...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tailwind-06B6D4?logo=tailwind-css">
...
- Led development of 70Languages.com using React, Tailwind, and Node.js
- Built real-time chat system with Socket.io
- Integrated ChatGPT API and Google Translate API
- Collaborated with cross-functional teams to deliver features on time

**Full Stack Intern** @ Rapid Proposal LLC (Remote)  
<sub>March 2022 - July 2023</sub>
- Optimized REST APIs (40% performance improvement)
- Developed admin panel for daily transaction management
- Enhanced security and scalability of backend services
...
Manarat International University (2020-2024)  
- GPA: 3.8/4.0 | Coursework: Software Engineering, AI, DB Systems

**Complete Web Development**  
Programming Hero Certification (2023)
